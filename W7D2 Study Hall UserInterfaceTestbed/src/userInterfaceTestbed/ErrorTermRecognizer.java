	...
	public static String checkErrorTerm(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				// In state 1, if the character is 0, it is accepted and we stay in this state.
				if (currentChar == '0') {
					nextState = 1;
					break;
				}
			...
			case 3:
				...
				// If the current character is 0, it transitions to state 3
				if (currentChar == '0') {
					nextState = 3;
					break;
				}
			...
			case 5: 
				...
				// If the current character is a '+' or '-", it transitions to state 5
			...
			case 9:
				...
				// If the current character is 0, it transitions to state 9
			    if (currentChar == '0') {
					nextState = 9;
					break;
				}
